...
const STORAGE_KEY = 'sideline-manager-v4-3-banner-icon'
...
function HeroBanner() {
  return <section className="hero hero-banner no-print striped-hero"><div className="hero-icon-card"><BrandMark /></div><div className="hero-copy banner-copy"><div className="title-badge app"><h1>SIDELINE MANAGER</h1></div><GrassStrip /><div className="hero-tagline">MANAGE. ROTATE. PERFORM.</div></div></section>
}
