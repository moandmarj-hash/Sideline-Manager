...
const STORAGE_KEY = 'sideline-manager-v4-2-cross-squad'
...
export default function App() {
  ...
  const onApplyQuickSwap=()=>{
    ...
    applyOverrideUpdate(swapState.outgoingSquad, currentInterval, { forceOff:[swapState.outgoingPlayer] })
    applyOverrideUpdate(swapState.incomingSquad, currentInterval, { forceOn:[swapState.incomingPlayer] })
    setSwapState((c)=>({ ...c, outgoingPlayer:'', incomingPlayer:'' }))
  }
